                    ...
                    <div class="row-fluid">
                        <div class="span9 m-cont">
                            ...
                            <div class="portfolio">    
                                ...
                                <div class="row-fluid" style="border-bottom: 1px dashed #ECECEC;">
                                    <div class="span5" style="margin-bottom: 20px;">
                                        <img width="340" height="200" alt="" src="http://www.stableflow.com/uploaded_files/images/uthi_AaM_decalkits.png" style="padding: 0;">
                                    </div>
                                    <div class="project_overview span7" style="margin-bottom: 20px;">    
...
<!--<p><i>Yii framework, Authorize.NET payment system integration</i></p>-->
                                ...
                                <div class="row-fluid" style="border-bottom: 1px dashed #ECECEC;">
                                    <div class="span5" style="margin-bottom: 20px;">
                                        <img width="340" height="200" alt="" src="http://www.stableflow.com/uploaded_files/images/Z4WzWUzG_zapper.png" style="padding: 0;">
                                    </div>
                                    <div class="project_overview span7" style="margin-bottom: 20px;">    
...
<!--<p><i>Barcode Scanning, MapKit, Web API integration
                                ...
                                <div class="row-fluid" style="border-bottom: 1px dashed #ECECEC;">
                                    <div class="span5" style="margin-bottom: 20px;">
                                        <img width="340" height="200" alt="" src="http://www.stableflow.com/uploaded_files/images/HHPxWBeA_ppgtrader.png" style="padding: 0;">
                                    </div>
                                    <div class="project_overview span7" style="margin-bottom: 20px;">    
...
<!--<p><i>PHP, Yii framework, Authorize.NET API</i></p>-->
                                ...
                                <div class="row-fluid" style="border-bottom: 1px dashed #ECECEC;">
                                    <div class="span5" style="margin-bottom: 20px;">
                                        <img width="340" height="200" alt="" src="http://www.stableflow.com/uploaded_files/images/QfHzKYHD_atmad.png" style="padding: 0;">
                                    </div>
                                    <div class="project_overview span7" style="margin-bottom: 20px;">    
...
<!--<p><i>iOS, MapKit, Web API integration</i></p>-->
                            ...
                            <script type="text/javascript" language="javascript" src="./HTML5 Portoflio_files/pagenavigator.js"></script>
                            <script>
