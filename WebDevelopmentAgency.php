...
<html class="sb-init">
    ...
    <body>
        ...
        <div id="pcat">
            <span class="btn_grey" style="margin: 0;"><a href="http://www#/#" class="sb-toggle-right" style="margin: 0;">Select a Category</a></span>
        </div>
    </div>
</div>
<div id="sb-site" style="min-height: 653px;">
    <div id="text">
        ...
        <link rel="stylesheet" href="./images/jquery.bxslider.css" type="text/css">
        <style>
            .home_title {
                font-size: 38px;    
            }
        ...
        <div class="container tech_carousel">
            ...
            <div class="list_carousel6 responsive" style="margin: 20px 0;">
                <div class="caroufredsel_wrapper" style="display: block; text-align: start; float: none; position: relative; top: auto; right: auto; bottom: auto; left: auto; z-index: auto; width: 1004px; height: 72px; margin: 0px; overflow: hidden;"><ul id="foo6" style="text-align: left; float: none; position: absolute; top: 0px; right: auto; bottom: auto; left: -246.447px; margin: 0px; width: 7028px; height: 72px; z-index: auto;">
                        <li style="width: 229px;"><img alt="" src="./images/php.png"></li><li style="width: 229px;"><img alt="" src="./images/mysql.png"></li><li style="width: 229px;"><img alt="" src="./images/html5.png"></li><li style="width: 229px;"><img alt="" src="./images/aws.png"></li><li style="width: 229px;"><img alt="" src="./images/wordpress.png"></li><li style="width: 229px;"><img alt="" src="./images/magento.png"></li><li style="width: 229px;"><img alt="" src="./images/android.png"></li><li style="width: 229px;"><img alt="" src="./images/ios.png"></li><li style="width: 229px;"><img alt="" src="./images/unity.png"></li><li style="width: 229px;"><img alt="" src="./images/social.png"></li><li style="width: 229px;"><img alt="" src="./images/js.png"></li><li style="width: 229px;"><img alt="" src="./images/jquery.png"></li></ul></div>
